...
function DrawPage() {
    ...
    return (
        <div className="draw gradient1">
            ...
            <h1>Lucky Draw</h1>
            <p>테스트 관리자 계정 admin@luckydtest.com / admin1234</p>
            <p>디자인은 주신 자료를 활용해 최대한 컨셉과 어울리게 맞춰드립니다.</p>
            <p>드로우 아래쪽에 흐리게 있는 '관리자로 로그인 / 관리자 페이지로 이동'을 통해 로그인 및 관리자 페이지를 체험하세요.</p>
